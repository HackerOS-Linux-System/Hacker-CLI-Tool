...
handle_unpack :: proc(args: []string, lang: string) {
	...
	switch sub {
		...
		case "hackeros-containers":
			...
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/HackerOS-Containers/main/install.hl -o /tmp/install-containers.hl")
		...
		case "h#", "hl-utils":
			...
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/H-Sharp/main/install-remove/HackerOS/install.hl -o /tmp/hsharp-install.hl")
			safe_run("hl run /tmp/hsharp-install.hl")
			safe_run("rm -f /tmp/hsharp-install.hl")
			fmt.printfln("%s%s%s", Colors.green, trans["unpack_done"], Colors.reset)

		case "h#-utils":
			fmt.printfln("%s%s H# Utils...%s", Colors.yellow, trans["unpack_downloading"], Colors.reset)
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/H-Sharp/main/install-remove/HackerOS/install-utils.hl -o /tmp/hsharp-utils-install.hl")
			safe_run("hl run /tmp/hsharp-utils-install.hl")
			safe_run("rm -f /tmp/hsharp-utils-install.hl")
			fmt.printfln("%s%s%s", Colors.green, trans["unpack_done"], Colors.reset)
		...
		case "hackeros-builder":
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/HackerOS-Builder/main/install.hl -o /tmp/install-builder.hl")
			safe_run("hl run /tmp/install-builder.hl")
			safe_run("rm -f /tmp/install-builder.hl")

		case "isolator":
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/Isolator/main/install.hl -o /tmp/install-isolator.hl")
		...
		case "hydra":
			...
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/hydra-look-and-feel/main/unpack.hl -o /tmp/unpack-hydra.hl")
			safe_run("hl run /tmp/unpack-hydra.hl")
			safe_run("rm -f /tmp/unpack-hydra.hl")
		...
		case "hammer":
			...
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/hammer/main/install.hl -o /tmp/install-hammer.hl")
			safe_run("hl run /tmp/install-hammer.hl")
			safe_run("rm -f /tmp/install-hammer.hl")
			fmt.printfln("%s%s%s", Colors.green, trans["unpack_done"], Colors.reset)

		case "hackeros-games-addons":
			fmt.printfln("%s%s hackeros-games-addons...%s", Colors.yellow, trans["unpack_downloading"], Colors.reset)
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/HackerOS-Games/main/addons.hl -o /tmp/addons.hl")
		...
		case "lpm":
			...
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/lpm/main/install.hl -o /tmp/install-lpm.hl")
			safe_run("hl run /tmp/install-lpm.hl")
			safe_run("rm -f /tmp/install-lpm.hl")
			fmt.printfln("%s%s%s", Colors.green, trans["unpack_done"], Colors.reset)

		case "hexai":
			fmt.printfln("%s%s HexAi...%s", Colors.yellow, trans["unpack_downloading"], Colors.reset)
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/HexAi/main/install.hl -o /tmp/hexai-install.hl")
		...
		case "hackerdeck":
			...
			safe_run("curl -fsSL https://raw.githubusercontent.com/HackerOS-Linux-System/HackerDeck/main/install.hl -o /tmp/hackerdeck-install.hl")
			safe_run("hl run /tmp/hackerdeck-install.hl")
			safe_run("rm -f /tmp/hackerdeck-install.hl")
			fmt.printfln("%s%s%s", Colors.green, trans["unpack_done"], Colors.reset)

		case:
			print_error("%s %s", trans["unpack_unknown"], sub)
			show_unpack_help(lang)
			os.exit(1)
	}
}
...
show_unpack_help :: proc(lang: string) {
	...
	cmds := [][2]string{
		...
		{"hackeros-containers",     trans["unpack_hackeros_containers"]},
		{"h#",                      trans["unpack_hsharp"]},
		{"h#-utils",                trans["unpack_hsharp_utils"]},
		...
		{"hackeros-games-addons",   trans["unpack_hackeros_games"]},
